 ...
 */
public class DControlFrame extends PApplet{
  ...
  public DControlFrame(PApplet _parent, int _w, int _h, String _name) 
  {
    this(_parent,
			_w, 
			_h , 
		DControlFrame.DEFAULT_WINDOW_LOCATION_X,
		DControlFrame.DEFAULT_WINDOW_LOCATION_Y,
		_name);
  }
  
  public DControlFrame(PApplet _parent, int _w, int _h, int locX, int locY, String _name) {
	super();   
    parent = _parent;
    w=_w;
    h=_h;
   ...
   */
  public DControlFrameWriter createNewControlFrameWriter(DControlFrameWriterOwner owner)
  {
      DControlFrameWriter cfw = new DControlFrameWriter(this, owner);
      return cfw;
  }
   ...
   */
    public ControlP5 getNewControlP5(DControlFrameWriterOwner cfwo) {
