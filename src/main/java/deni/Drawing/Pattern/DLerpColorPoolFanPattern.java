 ...
 * @author daudirac
 */
public class DLerpColorPoolFanPattern extends DLerpColorFanPattern
{
	public DLerpColorPoolFanPattern()
	{
		super();
	}
	...
	protected class LerpColorPoolFanDrawingObj extends DLerpColorFanPattern.FanDrawingObj
	{
	
		public LerpColorPoolFanDrawingObj(DMovementDescriber movementDescriber, float circleSize, float circleSizeInc) {
