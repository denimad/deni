...
public class DLine
{
    ...
    //=====================================
    public void calculateCollisionPoints(ArrayList<DLine> lines, boolean needToCalculateDrawingArea)
    {
    ...
    public float[] getCollisionPointWithLine(DLine line)
    {
        float cx,cy;
