 ...
 * @author daudirac
 */
public class DSeekMovementDescriber extends DMovementDescriberImpl implements DTargetMovementDescriber
{
    ...
    public DSeekMovementDescriber()
    {
        this(null, null, null);
    }

    public DSeekMovementDescriber(PVector location,
            PVector direction,
