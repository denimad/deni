 ...
 */
public abstract class DMovementDescriberImpl implements DMovementDescriber 
{
    ...
    DMovementDescriberImpl()
    {
        init(null, null);
    }
	
	DMovementDescriberImpl(PVector location, PVector direction)
    {
